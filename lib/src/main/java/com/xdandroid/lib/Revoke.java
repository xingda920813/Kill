    ...
    static void invokeHack(Context c) {
        ...
        pm.getInstalledPackages(PackageManager.GET_PERMISSIONS)
          ...
          .forEach(i -> {
              ...
              //if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) aom.setMode(AppOpsManager.OP_RUN_ANY_IN_BACKGROUND, uid, n, whiteListApp ? AppOpsManager.MODE_ALLOWED : AppOpsManager.MODE_IGNORED);
